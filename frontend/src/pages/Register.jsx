...
import { Mail, Lock, User, FileText, ArrowRight, CheckCircle } from 'lucide-react';
        ...
        <div className="max-w-md mx-auto w-full">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <p className="text-xs text-text-tertiary mt-2">At least 8 characters recommended</p>
            </div>
            ...
            <div className="flex items-start gap-3">
              <input
                ...
                type="checkbox"
                required
                className="w-4 h-4 mt-1 rounded border-border-default text-accent focus:ring-accent"
              />
